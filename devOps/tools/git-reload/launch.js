...
function LocalAppCluster(workerPerCore, appFile) {
    ...
    var numCpus = require('os').cpus().length,
        numWorkers = workerPerCore > 0 ? Math.ceil(numCpus * workerPerCore) : -workerPerCore,
...
//Constants
var NUMBER_OF_WORKERS_PER_CPU = 1; //Negative to set absolute 'n' workers in any scenario
